module ImportStatus
  ...
  IMPORT_MESSAGES = {
    ...
    PARTIAL_SUCCESS => "Some users were imported successfully, while others failed. Please check error messages.",
    FAILURE => "Could not import any users. Please check error messages.",
